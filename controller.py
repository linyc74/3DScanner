...
class Controller(object):
    ...
    def __init__(self, core_obj):
        '''
        Args:
            core_obj: The core object to be accessed and controlled by this Controller object
        '''
    ...
    def call_method(self, method_name, arg=None):
        '''
        Calls the method in the core object.

        Args:
            method_name: Type str. The name of the method in the core object to be called.
            arg: Default is None. Usually a tuple of arguments required by the method in the core object.
        '''
